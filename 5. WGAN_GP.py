...
pred_price, real_price, rmspe = gan.train(X_train, y_train, yc_train, epoch)
...
#
# # rescale the last
# real_price_sc = y_scaler.inverse_transform(real_price[-1])
# predicted_price_sc = y_scaler.inverse_transform(pred_price[-1])
#
